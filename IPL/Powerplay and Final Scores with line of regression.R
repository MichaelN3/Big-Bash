Data1<- read.csv('IPL Scores since 2014.csv')
...
Data1%>%filter(BallFace>=100)%>%ggplot(aes(PwrPlyRuns,RunScr))+
  ...
  labs(x = "Powerplay Runs", y = "Final Total",
       ...
       subtitle = "IPL since 2014")+
  annotate("label", x = 70, y = 100,
           label = "- Pearson correlation coefficient = 0.471\n- Gradient of regression of Powerplay Runs on Final Total = 1.23",
           family = "Fira Sans")
